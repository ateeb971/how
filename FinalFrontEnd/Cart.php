                    ...
                    <div class="col-lg-8 table-responsive mb-5">
                        <table class="table table-bordered text-center mb-0">
                            ...
                            <tbody class="align-middle">
                                <tr>
                                    <td class="align-middle"><img src="photo.jpeg" alt="" style="width: 50px;">Product 1
                                    </td>
                                    ...
                                    <td class="align-middle"><button class="btn btn-sm btn-primary"><i
                                                class="fa fa-times">X</i></button></td>
                                </tr>
                                <tr>
                                    <td class="align-middle"><img src="jeansTop.jpg" alt="" style="width: 50px;">
                                        Product 2</td>
                                    <td class="align-middle">₹150</td>
                                    <td class="align-middle">
                                        <div class="input-group quantity mx-auto" style="width: 100px;">
                                ...
                                <tr>
                                    <td class="align-middle"><img src="DenimOnepeice.jpg" alt="" style="width: 50px;">
                                        Product 2</td>
                                    <td class="align-middle">₹150</td>
                                    <td class="align-middle">
                                        <div class="input-group quantity mx-auto" style="width: 100px;">
                                ...
                                <tr>
                                    <td class="align-middle"><img src="SkirtTop.jpg" alt="" style="width: 50px;">
                                        Product 3</td>
                                    <td class="align-middle">₹150</td>
                                    <td class="align-middle">
                                        <div class="input-group quantity mx-auto" style="width: 100px;">
