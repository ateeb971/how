...
<?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") 
        {
            ...
            $q = "insert into customer(Name, mail_id, address, pin_code, contact_number, pw) values('$name','$mail_id','$address',$pin_code,'$contact_number','$pw')";
...
<body bgcolor="#eee">
    ...
    <div class="containe">
        ...
        <form name="RegForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="form">
            ...
            <div class="form-group">
                <p>Password<input type="password" value="" size="10" name="pw" id="myInput"><br><br>
            </div>
