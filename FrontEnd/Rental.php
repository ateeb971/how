...
<body>
  ...
  <main>
    ...
    $q = "SELECT name , price , descr from clothing";
    ...
    <div class="products-container">
      <div class="product">
        ...
        <div class="product-details">
          ...
          <p class="price"><?php echo $price ?> Rs/day</p>
          <form method="POST">
      ...
      <div class="product"> 
        <img src="jeansTop.jpeg" alt="Product 2">
        <div class="product-details">
          <h3><?php echo $name ?></h3>
          <p class="description"><?php echo $descr?></p>
          <p class="price"><?php echo $price ?> Rs/day</p>
      ...
      <div class="product">
        <img src="DenimOnepeice.jpeg" alt="Product 3">
        <div class="product-details">
          <h3><?php echo $name ?></h3>
          <p class="description"><?php echo $descr?></p>
          <p class="price"><?php echo $price ?> Rs/day</p>
